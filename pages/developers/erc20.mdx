...
2. Install the [MetaMask](https://metamask.io/) extension and configure it to connect to the Xone testnet.
3. Fund your MetaMask wallet with TXOC from a [faucet]().
...
3. Check smart contract address (e.g., 0x1F8ceB80df8b831e73aa8A15E2DcE229c214B82C).
