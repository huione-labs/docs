...
Visit the Xone XOC Release Page to start the process of releasing your XOC. <Link className='text-primaryHue' isExternal showAnchorIcon href="">Get started now</Link>
...
<Callout type="warning" emoji="⚠️">
  **Note:**  
  ...
  2. The amount of XOC you receive depends on the amount of WXOC you confirm for release. <Link className='text-primaryHue' showAnchorIcon href="">Check the calculation details here >></Link>
