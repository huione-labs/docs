...
### What is Epoch?
**Block height interval:** Xone Chain's Epoch is divided by block height interval, and each Epoch contains 172800 <Link className='text-primaryHue' showAnchorIcon href="/study/block">blocks</Link>.
  ...
  <Table key={new Date().getTime()} removeWrapper aria-label="XOC Fundraising Table" className="mt-2" defaultSelectedKeys={["4"]} selectionMode="single">
    ...
    <TableBody>
      ...
      <TableRow key="4">
        ...
        <TableCell>172800 blocks (~2 D)</TableCell>
