...
**NFT Description**:\
Minted as one of the earliest ambassadors for the public chain, it embodies a pioneering spirit and the mission to lead the industry. Holders of this NFT gain the distinguished status of global promoters of the public chain.\
**Supply**: 200\
**Protocol Standard**: BEP-1155\
**Network**: [Bscscan (BNB Smart Chain)](https://www.bnbchain.org/en)\
**NFT Address**: [0x47F018D9a1c6A4c6cee5D361dB8eD5d2B0252423](https://bscscan.com/address/0x47F018D9a1c6A4c6cee5D361dB8eD5d2B0252423)
...
<summary>5.Can I fill in the address of other chains?</summary>

Xone Pioneer NFT is issued based on the BNB Smart Chain (BSC) network and adopts the BEP-1155 standard. Therefore, all donors need to provide an address compatible with the BSC network to ensure the correct issuance of NFTs and the acquisition of rights and interests. Filling in the address of other chains may result in the failure to successfully receive NFTs or the inability to enjoy the relevant rights and interests in the Xone ecosystem. In order to ensure the security of your assets and the integrity of your rights and interests, it is recommended that you use a BSC address.

</details>

<details>

<summary>6.How can I contact you for assistance?</summary>
