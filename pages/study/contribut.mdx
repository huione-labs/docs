...
- <Link className='text-primaryHue' isExternal showAnchorIcon href="developers@xone.org">Email</Link>
...
<Callout emoji="💡">
  ...
  3. Approved PRs are typically merged into the `main` branch and trigger deployment to <Link className='text-primaryHue' isExternal showAnchorIcon href="https://docs.xone.org">docs.xone.org</Link> automatically.   
</Callout>

Once approved and merged, your contributions will appear live on <Link className='text-primaryHue' isExternal showAnchorIcon href="https://docs.xone.org">docs.xone.org</Link> within minutes. 🎉  
...
4. Merging accepted PRs, which are deployed to <Link className='text-primaryHue' isExternal showAnchorIcon href="https://docs.xone.org">docs.xone.org</Link> shortly after.  
